...
import com.yeogiya.web.member.service.CustomOAuth2UserService;
import com.yeogiya.web.member.service.OAuth2FailureHandler;
import com.yeogiya.web.member.service.OAuth2SuccessHandler;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/**/api-docs/**", "/swagger-ui/**", "/swagger-resources/**").permitAll()
                // 아이콘, css, js 관련
